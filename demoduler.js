...
const EXCLUDE_TOKENS = ['fflate', 'MMDParser', 'Stats', 'OIMO'];
const EMBED_NAMES = ['BufferGeometryUtils.js', 'CameraUtils.js', 'GeometryCompressionUtils.js', 'GeometryUtils.js', 'LDrawUtils.js', 'SceneUtils.js', 'SkeletonUtils.js'];
